...
use Trade17\Tests\Helper\Config;

class Trade17Printer extends PHPUnit\TextUI\ResultPrinter {
    private $results = [];
    private $criteria;
    ...
    protected function printFooter(TestResult $result): void
    {
        ...
        foreach ($this->results as $key => $tests) { // $key: ID of the group of tests
            ...
            $points = 0;
            $maxPoints = 0;
            $requireAllPassing = $this->criteria[$key]['requireAllPassing'] ?? false;
            ...
            // check if not all tests were successful in case all are required to pass
            if ($requireAllPassing && $points !== $maxPoints) {
                $points = 0;
            }
